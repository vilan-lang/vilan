...
<!-- STAGED for v0.16.0 — NOT a released version; fold into the section at cut
     time and delete this wrapper (the release gate greps for a live `## v` head).
