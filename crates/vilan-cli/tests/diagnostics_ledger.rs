...
const ROWS_THE_ENUMERATION_CANNOT_REACH: &[(&str, &str)] = &[
    ...
    ("351", "its B179 arm — a parameter right of a number's `+`"),
    ("352", "its B176 arm — bounded, but to the wrong promise"),
    ("353", "its plain no-string-form arm"),
    ("354", "its `str`-on-the-right arm"),
    ("355", "its same-type arm, the ladder's fallthrough"),
];
