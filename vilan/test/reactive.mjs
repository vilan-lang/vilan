...
function $P(self, value, $i) {
	self[0].v = __clone(value);
	$Q(self, $i);
}
function $V(self, transform, $W) {
	$P(self, transform($f(self)), $W);
}
