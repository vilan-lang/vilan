...
const themed = [ [ new Map([ [ "768px:dark hover:background-color", [ "768px:dark hover:background-color", [ "s8ahr6b", "background-color:var(--gray-50)" ] ] ], [ ":dark:background-color", [ ":dark:background-color", [ "suuxkdy", "background-color:var(--gray-900)" ] ] ], [ ":dark hover:background-color", [ ":dark hover:background-color", [ "s8ww588", "background-color:var(--gray-700)" ] ] ] ]) ] ];
...
const disclosed = [ [ new Map([ [ "768px:dark [data-open=\"true\"] hover:color", [ "768px:dark [data-open=\"true\"] hover:color", [ "s1pifanf", "color:var(--gray-50)" ] ] ], [ ":dark [data-open=\"true\"]:background-color", [ ":dark [data-open=\"true\"]:background-color", [ "s1bn73s7", "background-color:var(--gray-800)" ] ] ], [ ":[data-open=\"true\"]:display", [ ":[data-open=\"true\"]:display", [ "s11vlq4c", "display:flex" ] ] ], [ ":[data-open=\"true\"] hover:background-color", [ ":[data-open=\"true\"] hover:background-color", [ "s1j5l6ea", "background-color:var(--gray-100)" ] ] ] ]) ] ];
