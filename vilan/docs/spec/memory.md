...
[the design notes](https://github.com/vilan-lang/proposals/blob/main/archive/memory-management-rev-1.md)), the escape hatches, and resources
(design: [claims and epochs](https://github.com/vilan-lang/proposals/blob/main/proposal/claims-and-epochs.md), [destruction](https://github.com/vilan-lang/proposals/blob/main/proposal/destruction.md)). Rules
...
*(Design: [destruction](https://github.com/vilan-lang/proposals/blob/main/proposal/destruction.md).)* Rule 1 copies values, and a
