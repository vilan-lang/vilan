...
(function () {
	...
	hljs.registerLanguage("vilan", function (hljs) {
		const KEYWORDS = {
			...
			keyword: "async await borrows const css else enum export external for fun if impl import in is jump lazy let macro match mod mut own resource ret struct trait type use with",
