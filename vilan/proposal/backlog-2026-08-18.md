...
- **Now** — cycles 19–26 closed. Cycle 26 (2026-08-20) shipped E78
  ...
  active: the **v0.35.0 cut on 2026-08-22** — the first train on the
  scripts, the first fold under the ruleset, the fold that puts the
  re-themed book + masthead live; then the owner's kolt patches and the
  playground-todo A25 diff on the new toolchain.
