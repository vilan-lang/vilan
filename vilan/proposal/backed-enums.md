...
## 9. §7.1 resolved (cycle 13) — `Hashable` for bare-lowered enums
...
### 9.1 The mechanism, and the two it was chosen over
...
- **A blanket impl over bare-lowered enums.** Not expressible: the
  ...
  one of the two Hashable oracles (§9.3).
...
### 9.2 The unbacked C-like enum does NOT come along
...
### 9.3 The two Hashable oracles had to be made to agree
...
### 9.4 Collisions: the derive stands down, a hand-written impl does not
...
### 9.5 A resource enum: a bug found, and fixed
...
### 9.6 Two limits, both left where they were found
