...
20. **NEW — the watch-round sidecar flake, two strikes** (S; filed
    2026-07-25 per the recurrence rule — struck on the windows arc's first
    S1 gate (2026-07-24, local, 20.25s timeout vs 0.65s in isolation) and
    again on the F5-close CI run (ubuntu leg, same 20.5s shape)) —
